...
public class UtilsTest {
    ...
    @Test
    public void testSplit_bSEPb_limit3() {
    ...
    @Test
    public void testSplit_bSEPb_limit2() {
        final byte[] bytes = new byte[]{0x01, SEPARATOR, 0x02};
    ...
    @Test
    public void testSplit_bSEPb_limit1() {
        final byte[] bytes = new byte[]{0x01, SEPARATOR, 0x02};
    ...
    @Test
    public void testSplit_bSEPb_limit0() {
        final byte[] bytes = new byte[]{0x01, SEPARATOR, 0x02};
    ...
    @Test
    public void testSplit_SEPb_limit2() {
    ...
    @Test
    public void testSplit_bSEP_limit2() {
    ...
    @Test
    public void testSplit_SEP_limit2() {
    ...
    @Test
    public void testSplit_bSEPSEP_limit3() {
    ...
    @Test
    public void testSplit_SEPbSEP_limit3() {
    ...
    @Test
    public void testSplit_SEPSEP_limit3() {
    ...
    @Test
    public void testSplit_bSEPSEPb_limit3() {
    ...
    @Test
    public void testSplit_bb_limit2() {
    ...
    @Test
    public void testSplit_bbSEPbbbSEPbb_limit3() {
        final byte[] bytes = new byte[]{0x01, 0x02, SEPARATOR, 0x03, 0x04, 0x05, SEPARATOR, 0x06, 0x07};
        final List<byte[]> list = Utils.split(SEPARATOR, bytes, 3);
        assertEquals(3, list.size());
    ...
    @Test
    public void testSplit_bbSEPbbbSEPbb_limit2() {
        final byte[] bytes = new byte[]{0x01, 0x02, SEPARATOR, 0x03, 0x04, 0x05, SEPARATOR, 0x06, 0x07};
        final List<byte[]> list = Utils.split(SEPARATOR, bytes, 2);
        assertEquals(2, list.size());
        assertArrayEquals(new byte[]{0x01, 0x02}, list.get(0));
